...
namespace :groundwork do
  ...
  task :import_javascript do
    # Core Groundwork
    FileUtils.mkdir_p("web_client/www/lib/groundwork")
    FileUtils.cp("web_client/vendor/groundwork/js/groundwork.all.js", "web_client/www/lib/groundwork")
    ...
    Dir.glob("web_client/vendor/groundwork/js/libs/*").reject { |file|
      ...
      FileUtils.cp(file, "web_client/www/lib/groundwork/")
    end

    # Plugins
    FileUtils.cp_r("web_client/vendor/groundwork/js/plugins", "web_client/www/lib/groundwork/")
  end
