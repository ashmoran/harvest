    ...
    describe FishingGround do
        ...
        context "with valid attributes" do
          ...
          it "has an uncommitted fishing_ground_opened event" do
            expect(fishing_ground).to have_uncommitted_events(
              {
                message_type_name:    :fishing_ground_opened,
                uuid:                 :generated_uuid,
                name:                 "Fishing ground",
                starting_year:        2012,
                lifetime:             10,
      ...
      context "an open FishingGround" do
        ...
        describe "#close" do
          ...
          it "closes the FishingGround" do
            ...
            expect(fishing_ground).to have_uncommitted_events(
              { message_type_name: :fishing_ground_closed, uuid: :aggregate_uuid }
            )
          end
        end
        ...
        describe "#new_fishing_business_opened" do
          ...
          it "opens a new FishingBusiness" do
            ...
            expect(fishing_ground).to have_uncommitted_events(
              {
                message_type_name:             :new_fishing_business_opened,
                uuid:                   :aggregate_uuid,
      ...
      context "an open FishingGround with a FishingBusiness" do
        describe "#start_fishing" do
          ...
          it "starts fishing" do
            ...
            expect(fishing_ground).to have_uncommitted_events(
              { message_type_name: :fishing_started, uuid: :aggregate_uuid }
            )
          end
        end
        ...
        describe "#send_boat_out_to_sea" do
          ...
          context "valid Fishing Business" do
            it "submits the order" do
              ...
              expect(fishing_ground).to have_uncommitted_events(
                {
                  message_type_name: :fishing_order_submitted, order: 5,
      ...
      describe "fishing over one year" do
        describe "changing the order fulfilment policy" do
          ...
          it "uses the specified policy" do
            ...
            expect(fishing_ground).to have_uncommitted_events(
              { message_type_name: :fishing_order_unfulfilled, number_of_fish_caught: 0, uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_1 },
              { message_type_name: :fishing_order_fulfilled,   number_of_fish_caught: 30,  uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_2 }
            )
          end
        end
          ...
          context "all fishing orders are in" do
            context "fishing orders are within the current population" do
              ...
              it "fulfills the orders" do
                ...
                expect(fishing_ground).to have_uncommitted_events(
                  { message_type_name: :fishing_order_fulfilled, number_of_fish_caught: 5,  uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_1 },
                  { message_type_name: :fishing_order_fulfilled, number_of_fish_caught: 15, uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_2 },
                  { message_type_name: :fishing_order_fulfilled, number_of_fish_caught: 20, uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_3 }
                )
              end
              ...
              it "advances the year" do
                ...
                expect(fishing_ground).to have_uncommitted_events(
                  { message_type_name: :year_advanced, uuid: :aggregate_uuid, years_passed: 1, new_year: 2013 }
                )
              end
            end
            ...
            context "a fishing order exceeds the remaining population" do
              ...
              it "means the boat comes back empty" do
                ...
                expect(fishing_ground).to have_uncommitted_events(
                  { message_type_name: :fishing_order_fulfilled,   number_of_fish_caught: 5,  uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_1 },
                  { message_type_name: :fishing_order_fulfilled,   number_of_fish_caught: 15, uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_2 },
                  { message_type_name: :fishing_order_unfulfilled, number_of_fish_caught: 0, uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_3 }
                )
              end
            end
          end
        ...
        describe "fishing over multiple years" do
          describe "#end_current_year" do
            ...
            it "advances the year" do
              ...
              expect(fishing_ground).to have_uncommitted_events(
                { message_type_name: :year_advanced, years_passed: 1, new_year: 2014, uuid: :aggregate_uuid }
              )
            end
          end
        end
      ...
      describe "fishing until the end" do
        describe "#end_current_year" do
          ...
          it "advances the year" do
            ...
            expect(fishing_ground).to have_uncommitted_events(
              { message_type_name: :year_advanced, years_passed: 1, new_year: 2015 },
              { message_type_name: :fishing_ended },
              { message_type_name: :fishing_ground_closed }
            )
          end
        end
      end
      ...
      describe "regeneration" do
        context "fish population does not reach carrying capacity" do
          ...
          it "regenerates the fish" do
            ...
            expect(fishing_ground).to have_uncommitted_events(
              { message_type_name: :fish_regenerated, number_of_fish_regenerated: 15, new_population: 30, uuid: :aggregate_uuid }
            )
          end
        end
        ...
        context "fish population would exceed carrying capacity" do
          ...
          it "regenerates the fish up to the carrying capacity" do
            ...
            expect(fishing_ground).to have_uncommitted_events(
              { message_type_name: :fish_regenerated, number_of_fish_regenerated: 10, new_population: 50, uuid: :aggregate_uuid }
            )
          end
        end
      end
      ...
      describe "fishing for regenerated fish" do
        ...
        it "lets you catch these fish in a future year" do
          ...
          expect(fishing_ground).to have_uncommitted_events(
            { message_type_name: :fishing_order_fulfilled, number_of_fish_caught: 30, uuid: :aggregate_uuid, fishing_business_uuid: :business_uuid_1 }
          )
        end
      end
